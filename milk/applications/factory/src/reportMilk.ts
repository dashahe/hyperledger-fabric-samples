...
async function putMilkReport(milkID: string, cowID: string, machineID: string, operation: string) {
    try {
        ...
        const response = await contract.submitTransaction("putMilkReport", milkID, cowID, machineID, operation);
...
putMilkReport(
    "66666", "111", "777", "operation operation operation again"
);